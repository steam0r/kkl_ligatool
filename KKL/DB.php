...
//      "ORDER BY score DESC, gameDiff DESC, goalDiff DESC, team_scores.goalsFor DESC";
  ...
  public function createTeam($team) {
    ...
    $result = $this->getDb()->insert('teams', $values, array('%s', '%s', '%s', '%d', '%d'));
  ...
  public function createPlayer($player) {
    ...
    $result = $this->getDb()->insert('players', $values, array('%s', '%s', '%s', '%s'));
  ...
  public function createMatch($match) {
    ...
    $result = $this->getDb()->insert('matches', $values, array('%d', '%d', '%d', '%s', '%s', '%s', '%d', '%d', '%d'));
  ...
  public function createSet($set) {
    ...
    $result = $this->getDb()->insert('sets', $values, array('%d', '%d', '%d', '%d'));
  ...
  public function createGame($game) {
    ...
    $result = $this->getDb()->insert('games', $values, array('%d', '%d', '%d', '%d'));
  ...
  public function createLocation($location) {
    ...
    $result = $this->getDb()->insert('locations', $values, array('%s', '%s', '%s', '%s'));
  ...
  public function createLeague($league) {
    ...
    $result = $this->getDb()->insert('leagues', $values, array('%s', '%s', '%s'));
  ...
  public function createSeason($season) {
    ...
    $result = $this->getDb()->insert('seasons', $values, array('%s', '%s', '%s', '%d', '%d', '%d'));
  ...
  public function createClub($club) {
    ...
    if ($club->logo) {
      ...
      $result = $this->getDb()->insert('clubs', $values, array('%s', '%s', '%s', '%s'));
    } else {
      $result = $this->getDb()->insert('clubs', $values, array('%s', '%s', '%s'));
    }
  ...
  public function createGameDay($day) {
    ...
    $result = $this->getDb()->insert('game_days', $values, array('%d', '%s', '%s', '%d'));
  ...
  public function calculateScoresForTeamAndMatch($match, $team) {
    ...
    if ($score->id) {
      $result = $this->getDb()->update('team_scores', get_object_vars($score), array('id' => $score->id));
    } else {
      $result = $this->getDb()->insert('team_scores', get_object_vars($score));
    }
