...
class GameDays extends Controller {
  ...
  public function register_routes() {
    ...
    register_rest_route($this->getNamespace(), '/' . $this->getBaseName() . '/(?P<id>[\d]+)/next', array('methods' => WP_REST_Server::READABLE, 'callback' => array($this, 'get_next_gameday'), 'args' => array('context' => array('default' => 'view',),)));
    register_rest_route($this->getNamespace(), '/' . $this->getBaseName() . '/(?P<id>[\d]+)/previous', array('methods' => WP_REST_Server::READABLE, 'callback' => array($this, 'get_previous_gameday'), 'args' => array('context' => array('default' => 'view',),)));
  }
