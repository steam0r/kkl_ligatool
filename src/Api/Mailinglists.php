...
class Mailinglists extends Controller {
  ...
  public function register_routes() {
    register_rest_route($this->getNamespace(), '/' . $this->getBaseName() . '/league', array('methods' => WP_REST_Server::READABLE, 'callback' => array($this, 'get_league_list'), 'args' => array(),));
    register_rest_route($this->getNamespace(), '/' . $this->getBaseName() . '/admins', array('methods' => WP_REST_Server::READABLE, 'callback' => array($this, 'get_admin_list'), 'args' => array(),));
    register_rest_route($this->getNamespace(), '/' . $this->getBaseName() . '/resolve/(?P<email>[\S]+)', array('methods' => WP_REST_Server::READABLE, 'callback' => array($this, 'resolve_mail_address'), 'args' => array(),));
  }
