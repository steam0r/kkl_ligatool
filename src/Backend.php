...
class Backend {
  ...
  public static function add_screen_options() {
    ...
    foreach ($leagues as $league) {
      if ($league->getId() == $default_league) {
        $html .= '<option value="' . $league->getId() . '" selected="selected">' . $league->getName() . '</option>';
      } else {
        $html .= '<option value="' . $league->getId() . '">' . $league->getName() . '</option>';
      }
    }
    $html .= '</select><br/><br/>';
  ...
  public static function register_settings() {
    ...
    add_settings_section('kkl_ligatool_db', 'Integrations', array(__CLASS__, 'section_cb'), __FILE__);
