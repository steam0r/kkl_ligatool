...
abstract class DB {
    ...
    public function setSeasonProperties($season, $properties) {
        foreach ($properties as $key => $value) {
            ...
            if ($value !== false) {
                $this->getDb()->insert('season_properties', array(
                        'objectId'     => $season->id,
                        'property_key' => $key,
                        'value'        => $value,
                ), array('%d', '%s', '%s'));
    ...
    public function updateTeam($team) {
        ...
        $this->getDb()->update('teams', $columns, array('id' => $team->id), array(
                '%s',
                '%s',
                '%d',
                '%d',
    ...
    public function updatePlayer($player) {
        ...
        $this->getDb()->update('players', $columns, array('id' => $player->id), array(
                '%s',
                '%s',
                '%s',
                '%s',
    ...
    public function updateMatch($match) {
        ...
        $this->getDb()->update('matches', $values, array('id' => $match->id), array(
                '%d',
                '%d',
                '%d',
                '%s',
    ...
    public function updateSet($set) {
        ...
        $this->getDb()->update('sets', $values, array('match_id' => $set->match_id), array(
                '%d',
                '%d',
                '%d',
                '%d',
    ...
    public function updateGame($game) {
        ...
        $this->getDb()->update('games', $values, array('set_id' => $game->set_id), array(
                '%d',
                '%d',
                '%d',
                '%d',
    ...
    public function setTeamProperties($team, $properties) {
        foreach ($properties as $key => $value) {
            ...
            if ($value !== false) {
                $this->getDb()->insert('team_properties', array(
                        'objectId'     => $team->id,
                        'property_key' => $key,
                        'value'        => $value,
                ), array('%d', '%s', '%s'));
    ...
    public function setPlayerProperties($player, $properties) {
        foreach ($properties as $key => $value) {
            ...
            if ($value !== false) {
                $this->getDb()->insert('player_properties', array(
                        'objectId'     => $player->id,
                        'property_key' => $key,
                        'value'        => $value,
                ), array('%d', '%s', '%s'));
    ...
    public function updateLocation($location) {
        ...
        $this->getDb()->update('locations', $columns, array('id' => $location->id), array(
                '%s',
                '%s',
                '%s',
                '%s',
    ...
    public function updateLeague($league) {
        ...
        $this->getDb()->update('leagues', $columns, array('id' => $league->id), array(
                '%s',
                '%s',
                '%d',
                '%d',
    ...
    public function updateSeason($season) {
        ...
        $this->getDb()->update('seasons', $columns, array('id' => $season->id), array(
                '%s',
                '%s',
                '%s',
                '%d',
    ...
    public function updateClub($club) {
        ...
        if ($club->logo) {
            ...
            $this->getDb()->update('clubs', $columns, array('id' => $club->id), array(
                    '%s',
                    '%s',
                    '%s',
                    '%s',
    ...
    public function updateGameDay($day) {
        ...
        $this->getDb()->update('game_days', $columns, array('id' => $day->id), array(
                '%d',
                '%s',
                '%s',
                '%d',
