...
class Plugin {
	...
	public function __construct( $pluginFile, $baseUrl, $basePath ) {
		...
		static::registerShortCode( 'koelncup_table', "Darstellung der Tabelle", KoelnClub::class, 'renderTable' );
		static::registerShortCode( 'koelncup_games', "Liste aller eingetragenen Spiele ", KoelnClub::class, 'renderGames' );

		static::registerShortCode( 'kl-set-fixture', "set match fixture", SetMatchFixture::class, 'render' );
		static::registerShortCode( 'kl-ranking', "show ranking", RankingCode::class, 'render' );
		static::registerShortCode( 'league_table', "show table", LeagueTable::class, 'render' );
		static::registerShortCode( 'table_overview', "table overview", TableOverview::class, 'render' );
		static::registerShortCode( 'gameday_table', "gameday table", GameDayTable::class, 'render' );
		static::registerShortCode( 'gameday_overview', "gameday overview", GameDayOverview::class, 'render' );
		static::registerShortCode( 'league_overview', "league overview", LeagueOverview::class, 'render' );
		static::registerShortCode( 'club_detail', "club detail", ClubDetail::class, 'render' );
		static::registerShortCode( 'gameday_pager', "gameday pager", GameDayPager::class, 'render' );
		static::registerShortCode( 'season_schedule', "season schedule", SeasonSchedule::class, 'render' );
		static::registerShortCode( 'contact_list', "contact list", ContactList::class, 'render' );
		static::registerShortCode( 'set_match_fixture', "set match fixture", SetMatchFixture::class, 'render' );
	}

	public static function registerShortCode( $name, $description, $class, $method ) {
		$shortcode              = new \stdClass();
		$shortcode->name        = $name;
		$shortcode->description = $description;
		$shortcode->class       = $class;
		$shortcode->$method     = $method;
		static::$shortCodes[]   = $shortcode;
	}
	...
	public function init_shortcodes() {
		foreach ( static::$shortCodes as $shortcode ) {
			add_shortcode( $shortcode->name, array( $shortcode->class, $shortcode->method ) );
		}
	}
